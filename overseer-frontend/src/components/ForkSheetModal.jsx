...
import { forkSheet } from '../api/sheets';

export default function ForkSheetModal({ projectId, sourceSheet, onClose, onDone }) {
  ...
  const handleFork = async () => {
    ...
    setError('');
    try {
      const created = await forkSheet(projectId, sourceSheet.id, {
        name: trimmed,
