...
function LoadingSkeleton() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
      {[...Array(8)].map((_, i) => (
        <div key={i} className="bg-slate-900/40 rounded-2xl overflow-hidden animate-pulse border border-slate-800/70">
          <div className="aspect-[4/3] bg-slate-800/60" />
          <div className="px-3.5 py-3 space-y-2 border-t border-slate-800/60">
